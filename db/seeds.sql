...
INSERT INTO Guest (`name`, address, city, state, zip, phone) VALUES
	('Irvens Dupuy',	'110 Chamberlain PL ',	'Bridgeport', 'CT', '06606', '(123) 123-4567'),
	('Mike Trout',	'30 Main ST',	'Bridgeport', 'CT',	'51501', '(291) 553-0508'),
	('David Bijou', '24 Catherine ST', 'Norwalk', 'CT',	'99654', '(478) 277-9632'),
	('Rey Jean-Jacques', '9662 Foxrun Lane', 'Bridgeport', 'CT', '78552', '(308) 494-0198'),
	('Ramon Gravesandy', '9378 W. Augusta Ave.', 'Stratford', 'CT', '08096', '(214) 730-0298'),
	('Flaude Jean-Jacques', '762 Wild Rose Street', 'Brdigeport', 'CT', '48601', '(377) 507-0974'),
	('Monine Johnson',	'7 Poplar Dr.',	'Arvada', 'CO',	'80003', '(814) 485-2615'),
...
INSERT INTO Reservation (name, adults, children, start_date, end_date, total_room_cost, roomId, guestId) VALUES 
	...
	('Mike Trout', 2, 1, '2023-2-5', '2023-2-10', 999.95, 3, 3),
	('David Bijou', 2, 0, '2023-2-22', '2023-2-24', 349.98, 13, 4),
	('Rey Jean-Jacques', 2, 2, '2023-3-6', '2023-3-7', 199.99, 1, 5),
	('Ramon Gravesandy', 1, 1, '2023-3-17', '2023-3-20', 524.97, 15, 1),
	('Flaude Jean-Jacques', 3, 0, '2023-3-18', '2023-3-23', 924.95, 10, 6),
	('Monine Johnson', 2, 2, '2023-3-29', '2023-3-31', 349.98, 2, 7),
	...
	('Irvens Dupuy', 2, 0, '2023-6-28', '2023-7-2', 699.96, 5, 1),
